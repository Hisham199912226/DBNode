...
public class DaoTest {
    public static void main(String[] args) throws IOException {
        ...
        List<Document> documents = dao.readCollection("db1","col1");
        ...
        List<Document> documents1 = dao.readDocumentsByIDs("db1","col1",documentIds);
        ...
        List<Document> documents2 = dao.readCollection("db1","col1");
